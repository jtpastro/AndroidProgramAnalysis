...
import br.unb.visual.AndroidCallGraphFilter;
import br.unb.visual.Visualizer;
import soot.Scene;
...
public class AndroidCallgraph {
    ...
    static String apkPath = androidDemoPath + File.separator;
    ...
    public static void main(String[] args){
        ...
        if (args.length > 2)
	        ...
	        apkPath += ("app" + File.separator + "build" + File.separator + "outputs" + File.separator + "apk" + File.separator + "release" +  File.separator + "app-release-unsigned.apk");
        // Setup FlowDroid
